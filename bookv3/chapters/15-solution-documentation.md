...
נגד 100Ω בלייזר: לפי הדאטה־שיט של דיודות 5mW 650nm סטנדרטיות, $V_f \approx 3V$ ו־$I_d = 20mA$ נחשבים בטוחים. עם $V_{supply} = 5V$:

$$R = \frac{V_{supply} - V_f}{I_d} = \frac{5 - 3}{0.020} = 100\Omega$$

נגד 220Ω על Gate של MOSFET: מגן על ה־GPIO של ה־Pi מפני זרמי הסתערות בעת מעבר state. עם $V_{GPIO} = 3.3V$ ו־$I_{max} \approx 15mA$:
